...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'sign_submit') {
    ...
    if ($result['status'] === 'success') {
        ...
        $submitResult = $submissionHandler->submitByHead($_POST['submission_id'], $signedFile);
...
// Get submissions for this head
$submissions = $submissionHandler->getSubmissionsForHead($user['id']);
...
<!-- Pending Reviews -->
<?php Card::open('📋 Pending Reviews', 'Submissions from your employees awaiting your signature'); ?>
        ...
        <div class="space-y-4">
            <?php foreach ($submissions as $sub): ?>
                <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                    ...
                    <form action="head.php" method="POST" enctype="multipart/form-data" class="space-y-4 border-t border-gray-200 dark:border-gray-700 pt-4">
